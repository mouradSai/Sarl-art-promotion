      ...
      <div class="container">
        <div>
          <div class="header">
            ...
            <h1>Commande de vent </h1>
          </div>

          <div class="details">
            <div>
              <p class="font-bold text-neutral-600">Client</p>
              <p class="text-neutral-600">${clientName}</p>
            ...
            <tbody>
              ${commandes.map((item, index) => `
                <tr>
                  ...
                  <td class="text-center">${item.quantity * item.prixUnitaire} DA</td>
                </tr>
              `).join('')}
            </tbody>
          </table>
          <div class="text-right">
            <p class="font-bold highlight-bg">Versement: ${versement}</p>
            <p class="font-bold highlight-bg">Net total: ${calculateTotalCommandePrincipale()} DA</p>
          </div>
        </div>
