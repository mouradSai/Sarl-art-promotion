                      ...
                      <tr>
                        <td class="border-r pr-4">
                          <div>
                            ...
                            <p class="whitespace-nowrap font-bold text-main text-right">${`${today.getDate()}/${today.getMonth() + 1}/ ${today.getFullYear()}`}</p>
                          </div>
                        </td>
                        <td class="pl-4">
                          <div>
        ...
        <table class="w-full border-collapse border-spacing-0">
          <thead>
            <tr>
              ...
              <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Prix unt</td>
          ...
          <tbody>
            <tr>
              ...
              <td class="border-b py-3 pl-2 text-right">$150.00</td>
              <td class="border-b py-3 pl-2 pr-3 text-right"></td>
            </tr>
            <tr>
            ...
            <td class="border-b py-3 pl-2 pr-3 text-right"></td>
             ...
             <td class="border-b py-3 pl-2 pr-3 text-right"></td>
              ...
              <td class="border-b py-3 pl-2 pr-3 text-right"></td>
               ...
               <tr>
               <td class="border-b py-3 pl-3">7.</td>
               <td class="border-b py-3 pl-2"></td>
               <td class="border-b py-3 pl-2 text-right"></td>
               <td class="border-b py-3 pl-2 text-center"></td>
               <td class="border-b py-3 pl-2 text-center"></td>
               ...
               <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                ...
                <tr>
                <td class="border-b py-3 pl-3">8.</td>
                <td class="border-b py-3 pl-2"></td>
                <td class="border-b py-3 pl-2 text-right"></td>
                <td class="border-b py-3 pl-2 text-center"></td>
                <td class="border-b py-3 pl-2 text-center"></td>
                ...
                <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                 ...
                 <tr>
                 <td class="border-b py-3 pl-3">9.</td>
                 <td class="border-b py-3 pl-2"></td>
                 <td class="border-b py-3 pl-2 text-right"></td>
                 <td class="border-b py-3 pl-2 text-center"></td>
                 <td class="border-b py-3 pl-2 text-center"></td>
                 ...
                 <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                  ...
                  <tr>
                  <td class="border-b py-3 pl-3">10.</td>
                  <td class="border-b py-3 pl-2"></td>
                  <td class="border-b py-3 pl-2 text-right"></td>
                  <td class="border-b py-3 pl-2 text-center"></td>
                  <td class="border-b py-3 pl-2 text-center"></td>
                  ...
                  <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                   ...
                   <tr>
                   <td class="border-b py-3 pl-3">11.</td>
                   <td class="border-b py-3 pl-2"></td>
                   <td class="border-b py-3 pl-2 text-right"></td>
                   <td class="border-b py-3 pl-2 text-center"></td>
                   <td class="border-b py-3 pl-2 text-center"></td>
                   ...
                   <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                    ...
                    <tr>
                    <td class="border-b py-3 pl-3">12.</td>
                    <td class="border-b py-3 pl-2"></td>
                    <td class="border-b py-3 pl-2 text-right"></td>
                    <td class="border-b py-3 pl-2 text-center"></td>
                    <td class="border-b py-3 pl-2 text-center"></td>
                    ...
                    <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                     ...
                     <tr>
                     <td class="border-b py-3 pl-3">13.</td>
                     <td class="border-b py-3 pl-2"></td>
                     <td class="border-b py-3 pl-2 text-right"></td>
                     <td class="border-b py-3 pl-2 text-center"></td>
                     <td class="border-b py-3 pl-2 text-center"></td>
                     ...
                     <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                      ...
                      <tr>
                      <td class="border-b py-3 pl-3">14.</td>
                      <td class="border-b py-3 pl-2"></td>
                      <td class="border-b py-3 pl-2 text-right"></td>
                      <td class="border-b py-3 pl-2 text-center"></td>
                      <td class="border-b py-3 pl-2 text-center"></td>
                      ...
                      <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                       ...
                       <tr>
                       <td class="border-b py-3 pl-3">15.</td>
                       <td class="border-b py-3 pl-2"></td>
                       <td class="border-b py-3 pl-2 text-right"></td>
                       <td class="border-b py-3 pl-2 text-center"></td>
                       <td class="border-b py-3 pl-2 text-center"></td>
                       ...
                       <td class="border-b py-3 pl-2 pr-3 text-right"></td>
                        ...
                        <tr>
                        <td class="border-b py-3 pl-3">16.</td>
                        <td class="border-b py-3 pl-2"></td>
                        <td class="border-b py-3 pl-2 text-right"></td>
                        <td class="border-b py-3 pl-2 text-center"></td>
                        <td class="border-b py-3 pl-2 text-center"></td>
